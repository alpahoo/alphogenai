...
// 🔧 Config / Vars (prend d'abord l'env, sinon Pulumi config)
...
// --- R2 bucket ---
const bucket = new cloudflare.R2Bucket("assetsBucket", {
  accountId,
  name: r2Bucket,
});

// --- Worker (Modules) + binding R2 ---
const script = new cloudflare.WorkerScript("apiWorkerScript", {
  ...
  // ✅ API correcte : r2BucketBindings (champ "name")
  r2BucketBindings: [{
    name: r2Binding,
